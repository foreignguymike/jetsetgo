...
public class NameScreen extends Screen {
    ...
    private final TextEntity enterNameFont;
    private final TextEntity nameFont;
    ...
    public NameScreen(Context context) {
        ...
        enterNameFont = new TextEntity(context.getFont(Context.VCR20, 2f), "Enter Name", Constants.WIDTH / 2f, Constants.HEIGHT / 2f + 20, TextEntity.Alignment.CENTER);
        nameFont = new TextEntity(context.getFont(Context.VCR20), context.data.name, Constants.WIDTH / 2f, Constants.HEIGHT / 2f - 30, TextEntity.Alignment.CENTER);
